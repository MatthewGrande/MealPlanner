	...
	return (
		<Flex width="100%" height="100vh" direction="column">
			...
			<Flex direction="column" m="3rem">
				...
				<br></br>
				<h3><b>Calorie Goal: </b> ##Pull from backend##</h3>
				<br></br>
				<h3><b>Current Daily Calorie Count: </b> ##Pull from backend##</h3>
				<br></br>
				<h3><b>Progress so far: </b> ##Pull from backend##</h3>
				<br></br>
				<h3><b>Keep up the good work!!</b></h3>
			</Flex>
		</Flex>
	);
}
